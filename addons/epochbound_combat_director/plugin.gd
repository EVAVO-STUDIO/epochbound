...
const CombatDirectorStudio = preload("res://addons/epochbound_combat_director/combat_director_studio.gd")
const EditorPluginIcon = preload("res://addons/epochbound_editor_common/editor_plugin_icon.gd")
const ICON_CANDIDATES := ["AnimationPlayer", "CharacterBody2D"]

var studio


func _enter_tree() -> void:
	studio = CombatDirectorStudio.new()
	studio.name = "Combat Director"
