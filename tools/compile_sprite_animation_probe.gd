...
func _initialize() -> void:
	...
	if failures.is_empty():
		print("Sprite animation compile probe passed: catalogues, validators, grounded animation, adventure feedback, animated environments, editor, scaffolding, package safety and tests load cleanly.")
		quit(0)
		return
