...
func run_test() -> void:
	...
	runtime.set("play_time_seconds", 310.0)
...
func finish() -> void:
	if failures.is_empty():
		print("Archive Hideaway runtime smoke passed: authored travel, active-play return rewards, facility restoration, one-use warmth, save strictness and sanctuary authority are coherent.")
		quit(0)
		return
